...
# #creating a function
#
# def dibaties_prediction(input_data):
...
#     # if input_data_standardized.shape[1] != loaded_model.coef_.shape[1]:
...
#
#     # title
#     st.title('Dibates Prediction Webapp')
#
...
#         diagnosis = dibaties_prediction([Pregnancies, Glucose, BloodPressure, SkinThickness, Insulin, BMI, DiabetesPedigreeFunction, Age])
#
...
df = pd.read_csv('C:/Users/sriva/PycharmProjects/pythonProject/Diabaties Prediction System/diabetes.csv')



# HEADINGS
st.markdown("<h1 style='text-align: center; font-family: Times New Roman;'>Diabetes Prediction System</h1>", unsafe_allow_html=True)
